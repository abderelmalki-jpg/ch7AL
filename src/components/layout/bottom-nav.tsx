...
import { Home, Search, Camera, MapPin, User, Trophy } from "lucide-react";
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex flex-col items-center justify-center gap-1 text-muted-foreground transition-colors w-1/5",
